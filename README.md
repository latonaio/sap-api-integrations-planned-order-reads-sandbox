# sap-api-integrations-planned-order-reads  
...
以下の項目のうち、"PlannedOrder" ～ "SchedulingType" は、/SAP_API_Output_Formatter/type.go 内 の Type Product {} による出力結果です。"cursor" ～ "time"は、golang-logging-library による 定型フォーマットの出力結果です。  

```
{
	"cursor": "/Users/latona2/bitbucket/sap-api-integrations-planned-order-reads/SAP_API_Caller/caller.go#L58",
	...
	"time": "2021-12-19T20:56:54.196297+09:00"
}
